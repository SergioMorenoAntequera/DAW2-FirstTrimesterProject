...
class MoviesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $titles = Array("Al Este del Edén", "El niño con el pijama de rayas","La lista de Schindler", 
        ...
        $covers = Array("AlEsteDelEden.png", "NinoRayas.png", "LalistadeSchindler.png", "BurkaAmor.png",
                "Shrek.png", "Shrek2.png", "Shrek3.png", "Shrek4.png");
        $filepath = "movies";
        $filenames = Array("AlEsteDelEden.mp4", "NinoRayas.mp4", "LaListaDeSchindler.mp4", "BurkaAmor.mp4",
